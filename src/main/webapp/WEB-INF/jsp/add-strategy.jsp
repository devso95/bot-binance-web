...
<div class="container" style="width: 400px">
    <form:form modelAttribute="strategy" method="post" action="/add-strategy">
        ...
        <fieldset class="form-group">
            <form:label path="refId">Reference key</form:label>
            <br/>
            <form:input path="refId" type="text" class="form-control"/>
            <form:errors path="refId" cssClass="text-warning"/>
        </fieldset>
        ...
        <fieldset class="form-group">
            ...
            <br/>
            <form:input path="secretKey" type="password" class="form-control"/>
